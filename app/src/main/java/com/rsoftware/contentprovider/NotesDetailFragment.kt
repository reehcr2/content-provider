...
import com.rsoftware.contentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.rsoftware.contentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import com.rsoftware.contentprovider.database.NotesProvider.Companion.URI_NOTES
...
class NotesDetailFragment: DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(activity as Activity).setTitle(
            if (newNote) "Nova mensagem" else "Editar mensagem")
            .setView(view)
